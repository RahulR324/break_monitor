...
import { getTodayString, getDailyTotal } from '@/utils/time';

function App() {
  const { entries, addEntry, deleteEntry, clearAll } = useBreakEntries();
      ...
      <main className="mx-auto max-w-5xl px-4 py-6 sm:px-6 sm:py-8">
        <div className="grid grid-cols-1 gap-6 lg:grid-cols-2">
          <div className="space-y-6">
            ...
            <BreakForm onAdd={addEntry} currentDailyTotal={todayTotal} />
          </div>
          <div>
            <BreakHistory
              entries={entries}
